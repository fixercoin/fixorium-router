            ...
            <header className="fixed top-0 left-0 right-0 bg-darker/95 backdrop-blur-md border-b border-border z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-14">
                        {/* Left side - DEFI PLATFORM and Navigation Text */}
                        <div className="flex items-center gap-8">
                            ...
                            <nav className="hidden md:flex items-center gap-6">
                                ...
                                <button onClick={handleDexService} className="text-base text-gray-400 hover:text-primary transition uppercase tracking-wider">
                                    DEX SERVICE
                                </button>
            ...
            <div className="fixed top-14 left-0 right-0 bg-primary/10 border-y border-primary/20 overflow-hidden whitespace-nowrap py-2 z-40">
                <div className="inline-block animate-marquee whitespace-nowrap">
                    <span className="mx-4 inline-flex items-center gap-2">
                        ...
                        <span className="text-white text-[9px] uppercase tracking-wider">FIXORIUM EXCHANGE — MULTICHAIN DEX AGGREGATOR WITH NEW CRYPTO TRADE IDEAS</span>
                    </span>
                    <span className="mx-4 inline-flex items-center gap-2">
                        <span className="text-yellow-400 text-[10px] uppercase tracking-wider font-semibold">WALLET</span>
                        <span className="text-white text-[9px] uppercase tracking-wider">FIXORIUM WALLET — MULTICHAIN WALLET SUPPORTING SOLANA, EVM, MINTME BLOCKCHAIN WITH POOL CREATION SYSTEM</span>
                    </span>
                    <span className="mx-4 inline-flex items-center gap-2">
                        <span className="text-yellow-400 text-[10px] uppercase tracking-wider font-semibold">ROUTER</span>
                        <span className="text-white text-[9px] uppercase tracking-wider">MINTME FIXORIUM ROUTER — FREE TO USE FIXORIUM DEX ROUTER AVAILABLE AFTER REGISTRATION</span>
                    </span>
                    <span className="mx-4 inline-flex items-center gap-2">
                        <span className="text-yellow-400 text-[10px] uppercase tracking-wider font-semibold">MAX</span>
                        <span className="text-white text-[9px] uppercase tracking-wider">MAX AGGREGATOR — SUPER FAST • VERY LOW FEES • MULTICHAIN AGGREGATOR</span>
                    </span>
                    <span className="mx-4 inline-flex items-center gap-2">
                        <span className="text-yellow-400 text-[10px] uppercase tracking-wider font-semibold">API</span>
                        <span className="text-white text-[9px] uppercase tracking-wider">GET MAX API KEY & SECRET KEY AFTER REGISTRATION — EASY TO INTEGRATE WITH SIMPLE ICONS</span>
                    </span>
                </div>
            </div>
